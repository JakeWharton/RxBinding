...
public final class RxSnackbar {
   ...
   */
  @CheckResult @NonNull
  public static Observable<View> actionClicked(@NonNull Snackbar view, int resId) {
    checkNotNull(view, "view == null");
   ...
   */
  @CheckResult @NonNull
  public static Observable<View> actionClicked(@NonNull Snackbar view, @NonNull CharSequence text) {
    checkNotNull(view, "view == null");
