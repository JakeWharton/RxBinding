...
public final class AdapterViewItemLongClickEvent extends ViewEvent<AdapterView<?>> {
  @CheckResult
  @NonNull
  public static AdapterViewItemLongClickEvent create(
          @NonNull AdapterView<?> view, @NonNull View clickedView, int position, long id) {
  ...
  private AdapterViewItemLongClickEvent(
          @NonNull AdapterView<?> view, @NonNull View clickedView, int position, long id) {
    super(view);
