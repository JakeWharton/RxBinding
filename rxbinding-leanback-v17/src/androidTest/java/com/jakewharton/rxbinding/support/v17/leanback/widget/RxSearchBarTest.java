...
public final class RxSearchBarTest {
  ...
  @Before public void setUp() {
    searchBar = activityRule.getActivity().searchBar;
    searchEditText = activityRule.getActivity().searchEditText;
  }
  ...
  @Test @UiThreadTest public void searchQueryChangeEvents() {
    ...
    assertThat(event.searchQuery().toString()).isEqualTo("q");
  ...
  @Test @UiThreadTest public void searchQueryChangeEventsKeyboardDismissed() {
    ...
    assertThat(event1.searchQuery().toString()).isEqualTo("q");
