...
import static com.jakewharton.rxbinding3.appcompat.RxToolbarTestActivity.NAVIGATION_CONTENT_DESCRIPTION;
...
public final class RxToolbarTest {
  ...
  @Test @UiThreadTest public void itemClicks() {
    ...
    com.jakewharton.rxbinding3.appcompat.RxToolbar.itemClicks(view).subscribe(o);
