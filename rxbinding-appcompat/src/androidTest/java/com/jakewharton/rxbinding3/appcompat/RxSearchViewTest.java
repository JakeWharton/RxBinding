...
public final class RxSearchViewTest {
  ...
  @Test @UiThreadTest public void queryTextChanges() {
    ...
    com.jakewharton.rxbinding3.appcompat.RxSearchView.queryTextChanges(searchView).subscribe(o);
  ...
  @Test @UiThreadTest public void queryTextEventNotSubmitted() {
    ...
    com.jakewharton.rxbinding3.appcompat.RxSearchView.queryTextChangeEvents(searchView).subscribe(o);
